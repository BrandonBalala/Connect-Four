...
public class BoardController {
	...
	private Label[] arrayLabels = { label00, label01, label02, label03, label04, label05, label10, label11, label12,
			label13, label14, label15, label20, label21, label22, label23, label24, label25, label30, label31, label32,
			label33, label34, label35, label40, label41, label42, label43, label44, label45, label50, label51, label52,
			label53, label54, label55, label60, label61, label62, label63, label64, label65 };
	...
	void userClick(ActionEvent event) {
		Node n = (Node)event.getSource().getInt();
		//send packet to serrver with column chosen
	}
